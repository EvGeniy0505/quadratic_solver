...
solve: main.o count_roots.o input_and_output.o other_func.o
	@g++ $(flags) main.o count_roots.o input_and_output.o other_func.o -o solve

main.o: main.cpp
	@g++ -c main.cpp $(flags)

count_roots.o: count_roots.cpp
	@g++ -c count_roots.cpp $(flags)

input_and_output.o: input_and_output.cpp
	@g++ -c input_and_output.cpp $(flags)

other_func.o: other_func.cpp
	@g++ -c other_func.cpp $(flags)
